...
fetch(`http://localhost:3000/api/products/${idProduct}`)
    ...
    .then((res) => {
        ...
        ).lastElementChild.innerText = res.price * quantityProduct + ' €';
        // ajout évolution du prix en fonction de la quantité
        document
            .querySelector('.cart__item__content__settings__quantity input')
            .addEventListener('change', function () {
                ...
                if (newQuantity > quantityProduct) {
                    document.querySelector(
                        ...
                        res.price * newQuantity + ' €';
                } else if (newQuantity < quantityProduct) {
                    document.querySelector(
                        '.cart__item__content__description'
                    ).lastElementChild.innerText =
                        res.price * newQuantity + ' €';
